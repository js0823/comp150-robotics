...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_ros_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jyoon10/gitrepo/comp150-robotics/catkin_ws/install/${idir}'.  Ask the maintainer 'Jose Luis Rivero <jrivero@osrfoundation.org>' to fix it.")
    endif()
